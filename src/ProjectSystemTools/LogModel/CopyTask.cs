...
namespace Microsoft.VisualStudio.ProjectSystem.Tools.LogModel
{
    internal sealed class CopyTask : Task
    {
        ...
        //    return result;
        //}
        public CopyTask(ImmutableList<string> messages, DateTime startTime, DateTime endTime, bool succeeded, int nodeId, string name, string fromAssembly, string commandLineArguments, string sourceFilePath) : base(messages, startTime, endTime, succeeded, nodeId, name, fromAssembly, commandLineArguments, sourceFilePath)
        {
        }
    }
}
